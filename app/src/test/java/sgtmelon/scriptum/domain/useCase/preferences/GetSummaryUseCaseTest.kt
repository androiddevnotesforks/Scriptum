 ...
 */
abstract class GetSummaryUseCaseTest<T: ParentEnumConverter<*>> : ParentTest() {
    ...
    abstract fun `simple summary get`()

    abstract fun `summary get with data set`()

    @Test fun `summary get with bad converting`() {

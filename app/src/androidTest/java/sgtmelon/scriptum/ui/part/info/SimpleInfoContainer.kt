 ...
 */
class SimpleInfoContainer(page: SimpleInfoPage) : ParentInfoContainer(when(page) {
    ...
    override val includeContainer = getViewById(when (page) {
    ...
    override val titleText = getView(R.id.info_title_text, when (page) {
    ...
    override val detailsText = getView(R.id.info_details_text, when (page) {

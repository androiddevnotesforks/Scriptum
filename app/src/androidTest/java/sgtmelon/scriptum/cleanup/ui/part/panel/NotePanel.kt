...
class NotePanel<T : ContainerPart, N : NoteItem>(
        ...
        callback.apply {
            ...
            when (state) {
                ...
                NoteState.EDIT, NoteState.NEW -> {
                    ...
                    val saveTextColor = if (isSaveEnabled) R.attr.clContent else R.attr.clContentThird
    ...
    @AttrRes private fun getEnableTint(b: Boolean) = if (b) R.attr.clContent else R.attr.clContentThird

...
/**
 * Test overscroll color in [RollNoteFragment] with [ThemeDisplayed.LIGHT] theme.
 */
@RunWith(AndroidJUnit4::class)
class RollNoteOverscrollLightTest : NoteOverscrollTestCase(ThemeDisplayed.LIGHT, NoteType.ROLL) {
